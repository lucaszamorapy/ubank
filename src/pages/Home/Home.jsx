        ...
        <div className="container">
          <div className="flex flex-col justify-center gap-4 lg:grid lg:grid-cols-2">
            <div className="flex flex-col  gap-4">
              <h1 className="text-black px-5 text-4xl uppercase font-semibold leading-1 lg:px-0 lg:text-6xl">
                Aprenda sobre <br />{" "}
                <span className="text-purpleBank">finanças</span> e conquiste
                seus <br /> <span className="text-blueBank">sonhos</span>
              </h1>
            ...
            <img
              src={image}
              alt=""
              className="w-full px-5 object-contain lg:h-[750px] lg:px-0 lg:ml-10"
            />
          </div>
        </div>
      </section>
